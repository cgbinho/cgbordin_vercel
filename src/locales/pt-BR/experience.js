export default {
  ...
  coding: {
    ...
    <li><span>•</span> Stripe API e outros.</li>
    </ul>`,
  },
  design: {
  ...
  rest: {
    title: 'Mais Tecnologias que já tive contato',
    img: '/images/cgbordin_experience_rest.svg',
    excerpt: `<ul>
    <li><span>•</span> Rest API</li>
    <li><span>•</span> Cypress</li>
    <li><span>•</span> AWS Amplify</li>
    <li><span>•</span> Vercel</li>
    ...
    <li><span>•</span> Princípios SOLID</li>
    <li><span>•</span> JWT e outros.</li>
    </ul>`,
  },
};
